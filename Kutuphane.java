...
public class Kutuphane {
    ...
    public void EvoData(String url, int method, final Callback callback) {
        ...
        if (internetKontrol())
            ...
            EvoDialogInterface("�?u anda internet bağlantınız olmadığından programı aktif olarak kullanamıyorsunuz. Lütfen internete bağlı olduğunuzdan emin olun.", "Bağlantı Hatası", new cikisKarari() {
                @Override
